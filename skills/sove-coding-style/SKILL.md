...
description: Personal coding-style rules for Vue, Nuxt, frontend UI, JavaScript, and TypeScript. Use whenever writing, reviewing, debugging, or refactoring related code; load all applicable reference files before making changes.
---
...
- **Nuxt**: Read [references/nuxt.md](references/nuxt.md) and [references/vue.md](references/vue.md).
...
A task can require multiple references. For example, a Nuxt component written in TypeScript with visual UI work requires the Nuxt, Vue, TypeScript, and frontend UI references.
...
5. Keep technology-specific details in their reference files. Do not expand `SKILL.md` with Vue, Nuxt, UI, JavaScript, or TypeScript style rules.